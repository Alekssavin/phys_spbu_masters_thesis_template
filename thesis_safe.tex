%thesis_safe.tex
%Это основной tex-файл, собирающий документ воедино. Данный файл можно скомпилировать с помощью стандартного компилятора LaTex, без XeLaTeX. Шрифт "Times New Roman", однако, работать не булет.
...
\usepackage[bookmarks]{hyperref}  %интерактивная индексация в pdf.

% Начало документа:
\begin{document}
  
  \input{./chapters/title.tex} %вставить титульный лист.
  ...
  \input{./chapters/anotation.tex}  %вставить аннотацию и ключевые слова.

  \newpage

  \input{./chapters/introduction.tex} %вставить введение.

  \newpage

  \input{./chapters/literature.tex} %вставить обзор литературы и предшествующих работ.

  \newpage

  \input{./chapters/body.tex} %вставить основную часть. Её можно при желании разбит на несколько отдельных документов.

  \newpage

  \input{./chapters/conclusion.tex} %вставить заключительную часть.

  \newpage

  \include{./chapters/equipment}  %перечень использованного оборудования.
